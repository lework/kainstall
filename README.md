...
| network | [calico](https://github.com/projectcalico/calico) | 3.20.0 | ![calico release ](https://img.shields.io/github/v/release/projectcalico/calico?sort=semver) |
...
| ingress | [ingress nginx controller](https://github.com/kubernetes/ingress-nginx) | 1.0.0          | ![ingress-nginx release](https://img.shields.io/github/v/release/kubernetes/ingress-nginx) |
| ingress | [traefik](https://github.com/traefik/traefik) | 2.5.1         | ![traefik release ](https://img.shields.io/github/v/release/traefik/traefik?sort=semver) |
...
| log | [elasticsearch](https://github.com/elastic/elasticsearch) | 7.14.0         | ![elasticsearch release](https://img.shields.io/github/v/release/elastic/elasticsearch?sort=semver) |
| storage | [rook](https://github.com/rook/rook) | 1.7.2 | ![rook release](https://img.shields.io/github/v/release/rook/rook?sort=semver) |
...
INGRESS_NGINX="${INGRESS_NGINX:-1.0.0}"
TRAEFIK_VERSION="${TRAEFIK_VERSION:-2.5.1}"
CALICO_VERSION="${CALICO_VERSION:-3.20.0}"
...
ROOK_VERSION="${ROOK_VERSION:-1.7.2}"
LONGHORN_VERSION="${LONGHORN_VERSION:-1.2.0}"
